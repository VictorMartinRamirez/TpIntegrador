...
public class Partido {
    ...
    public Partido(Equipo equipo1, Integer golesEquipo1, Equipo equipo2, Integer golesEquipo2, int numeroRonda) {
    ...
    public String toString() {
        return "Partido{" + "equipo1=" + equipo1 + ", golesEquipo1=" + golesEquipo1 + ", equipo2=" + equipo2 + ", golesEquipo2=" + golesEquipo2 + ", resultado=" + resultado + ", numeroRonda=" + numeroRonda + '}';
    }
